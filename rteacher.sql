...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2019 a las 18:15:49
...
) ENGINE=FEDERATED connection='mysql://cliente@127.0.0.1:3306/adminbd/usuarios' DEFAULT CHARSET=utf8mb4;
...
(29, 39, 1, 1, 7, 7, 89, 1, 'Comment', 0, 0, 0);
...
--
ALTER TABLE `calificacion`
  MODIFY `id_calificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `descripciones_rapidas`
  MODIFY `id_descripciones_rapidas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `descripcion_calificacion`
--
ALTER TABLE `descripcion_calificacion`
  MODIFY `id_descripcion_calificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `escuela`
--
ALTER TABLE `escuela`
  MODIFY `id_Escuela` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `maestro`
--
ALTER TABLE `maestro`
  MODIFY `id_maestro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
